...
#
# The gs_power_uct_er rows are placeholders: they inherit the tuned (C, P) of gs_power_uct and use
# the paper's default coefficients C2 = C3 = 0.5. Replace them with the best ER row from
# tune_result.txt before reporting numbers, and enable the algorithm in run_final.sh.
...
get_final_params() {
    ...
    case "${env_name}:${algorithm}" in
        ...
        frozen_lake:gs_power_uct_er) FINAL_PARAMS=("0.5" "0.0" "0.5" "0.5") ;;
        ...
        four_rooms:gs_power_uct_er) FINAL_PARAMS=("0.5" "0.0" "0.5" "0.5") ;;
        ...
        passenger_grid:gs_power_uct_er) FINAL_PARAMS=("0.5" "0.0" "0.5" "0.5") ;;
        ...
        factored_river_swim:gs_power_uct_er) FINAL_PARAMS=("0.5" "2.5" "0.5" "0.5") ;;
        ...
        sysadmin_ring:gs_power_uct_er) FINAL_PARAMS=("0.5" "2.5" "0.5" "0.5") ;;
